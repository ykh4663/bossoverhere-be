...
public class PostDto {
    ...
    @Schema(description = "스팟 정보", implementation = SpotDto.class)
    private SpotDto spot;

    @Schema(description = "영업 시작 일시", example = "2025-07-30T09:00:00")
    private LocalDateTime startAt;

    @Schema(description = "영업 종료 일시", example = "2025-07-30T17:00:00")
    ...
    @Schema(description = "생성 일시", example = "2025-07-30T18:00:00")
    private LocalDateTime createdAt;

    @Schema(description = "수정 일시", example = "2025-07-30T18:30:00")
    ...
    public PostDto(Post post) {
        ...
        this.spot = SpotDto.from(post.getSpot());
